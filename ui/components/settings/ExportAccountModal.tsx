...
export function ExportAccountModal({ isOpen, onOpenChange }: ExportAccountModalProps) {
    const {
        isExporting,
        exportedData,
        error,
                        ...
                        <Modal.Body className="px-8 py-6">
                            {isExporting ? (
                                ...
                                <div className="flex flex-col items-center justify-center py-12 gap-4 text-center">
                                    ...
                                    <Button variant="secondary" size="sm" onPress={() => exportAccount()}>
                                        Try Again
                                    </Button>
                                </div>
                            ) : exportedData ? (
                                <div className="flex flex-col items-center gap-6 animate-in fade-in zoom-in-95 duration-300">
                                    ...
                                    <div className="flex items-start gap-3 p-3 rounded-xl bg-success/5 border border-success/20 w-full">
                                        ...
                                        <div>
                                            <p className="text-xs font-semibold text-success">End-to-End Encrypted</p>
