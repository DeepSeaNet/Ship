...
import { MdMic, MdAdd, MdLogin } from 'react-icons/md';
...
export function JoinOrCreateView({ onCreateCall, onJoinCall, onCancel }: JoinOrCreateViewProps) {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full h-full p-10 gap-8">
            ...
            <div className="text-center">
                <h2 className="text-white text-2xl font-bold tracking-tight mb-2">Voice Chat</h2>
